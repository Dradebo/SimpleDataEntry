...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideAuthRepository(@ApplicationContext context: Context, d2Provider: () -> D2?,sessionManager: SessionManager): AuthRepository {
        return AuthRepositoryImpl(context, d2Provider, sessionManager)
    }
